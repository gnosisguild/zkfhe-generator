...
impl EncBfvCircuit {
    /// Create a new EncBfvCircuit with the specified security parameter
    ///
    /// # Arguments
    ///
...
impl Circuit for EncBfvCircuit {
    ...
    fn generate_toml(
        ...
        EncBfvConfigsGenerator::generate_configs_file(
            &crypto_params,
            &bounds,
            &template_params,
            output_dir,
...
mod tests {
    ...
    fn test_circuit_name_and_description() {
        let circuit = EncBfvCircuit::new(shared::DEFAULT_INSECURE_LAMBDA);
