...
use shared::{DEFAULT_INSECURE_LAMBDA, DEFAULT_SECURE_LAMBDA, SecurityLevel};
use std::sync::Arc;
    ...
    pub fn metadata(&self) -> PresetMetadata {
        match self {
            ...
            BfvPreset::SecureThresholdBfv8192 | BfvPreset::SecureDkg8192 => PresetMetadata {
                ...
                num_parties: secure_8192::threshold::NUM_PARTIES,
...
mod tests {
    ...
    fn test_metadata_values() {
        ...
        assert_eq!(metadata.num_parties, secure_8192::threshold::NUM_PARTIES);
